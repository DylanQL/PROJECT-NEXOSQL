          ...
          <Col>
            <Card className="border-success">
              <Card.Header className="bg-success text-white">
                <h5 className="mb-0">Mi Suscripción Actual</h5>
              </Card.Header>
              <Card.Body>
                <Row>
                  <Col md={6}>
                    <h6>
                      Plan:{" "}
                      <Badge bg="primary">
                        {plans[currentSubscription.planType]?.name}
                      </Badge>
                    </h6>
                    <p>
                    ...
                    <p>
                      ...
                      {formatPrice(currentSubscription.price)}/mes
                    </p>
                  </Col>
                  <Col md={6}>
                    <p>
        ...
        <Col>
          ...
          <div className="accordion" id="faqAccordion">
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  ...
                  Los cambios se aplicarán inmediatamente y se prorratearán
                  según corresponda.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Al cancelar tu suscripción, mantendrás el acceso a las
                  funciones premium hasta el final del período de facturación
                  actual. Después de eso, tu cuenta volverá al plan gratuito.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Sí, utilizamos PayPal como procesador de pagos, que es una de
                  las plataformas más seguras del mundo. No almacenamos
