...
class PayPalService {
  constructor() {
    this.clientId =
      ...
      "AR_aJX5pNGAGM_aodiVmtR_jypetl-RnOWykHg_1PjYLiF3ajuSlvhN0BxuS11UZ2hYWNmSrCBEPcKaT";
    this.clientSecret =
      process.env.PAYPAL_CLIENT_SECRET ||
      "EFtcAGXTj-5uXKqLYDw7Z8bnjkohJ2X657_SbL0XXAmb0tPjX7ICk0BROCfUxh6ZSkFmQnpcu4hGIBFm";
    this.baseURL =
  ...
  async getSubscription(subscriptionId) {
    try {
      ...
      console.error(
        "Error getting PayPal subscription:",
        error.response?.data || error.message,
      );
  ...
  async suspendSubscription(
    ...
    try {
      ...
      console.error(
        "Error suspending PayPal subscription:",
        error.response?.data || error.message,
      );
  ...
  async activateSubscription(
    ...
    try {
      ...
      console.error(
        "Error activating PayPal subscription:",
        error.response?.data || error.message,
      );
